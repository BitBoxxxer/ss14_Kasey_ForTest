...
{
    // i hate this shit - Kasey 25.01.26
    ...
    public sealed class StyleOS : StyleBase
    {
        ...
        // OceanStar цветовая палитра
        public static readonly Color PanelDark = Color.FromHex("#18090d"); // PrimaryPalette.background
        public static readonly Color PanelLight = Color.FromHex("#261218"); // PrimaryPalette.element

        public static readonly Color OceanGold = Color.FromHex("#FB6734"); // PrimaryPalette.text / PositivePalette.element
        public static readonly Color OceanRed = Color.FromHex("#CE3737"); // SecondaryPalette.text / NegativePalette.element
        public static readonly Color OceanDarkRed = Color.FromHex("#8b1111"); // NegativePalette.background
        public static readonly Color OceanSecondary = Color.FromHex("#6B1A34"); // SecondaryPalette.element
        public static readonly Color OceanHighlight = Color.FromHex("#1B3854"); // HighlightPalette.element

        public static readonly Color GoodGreenFore = Color.FromHex("#3E6C45");
        public static readonly Color ConcerningOrangeFore = Color.FromHex("#A5762F");
        public static readonly Color DangerousRedFore = Color.FromHex("#BB3232");
        public static readonly Color DisabledFore = Color.FromHex("#5A5A5A");

        // Кнопки - обновленные цвета под OceanStar
        public static readonly Color ButtonColorDefault = Color.FromHex("#261218"); // PrimaryPalette.element
        public static readonly Color ButtonColorDefaultRed = Color.FromHex("#CE3737"); // OceanRed
        public static readonly Color ButtonColorHovered = Color.FromHex("#6B1A34"); // OceanSecondary
        public static readonly Color ButtonColorHoveredRed = Color.FromHex("#FB6734"); // OceanGold
        public static readonly Color ButtonColorPressed = Color.FromHex("#440a2c"); // SecondaryPalette.background
        public static readonly Color ButtonColorDisabled = Color.FromHex("#30313c");

        public static readonly Color ButtonColorCautionDefault = Color.FromHex("#CE3737"); // OceanRed
        public static readonly Color ButtonColorCautionHovered = Color.FromHex("#FB6734"); // OceanGold
        public static readonly Color ButtonColorCautionPressed = Color.FromHex("#8b1111"); // OceanDarkRed
        ...
        //NavMap
        public static readonly Color PointRed = Color.FromHex("#CE3737"); // OceanRed
        public static readonly Color PointGreen = Color.FromHex("#FB6734"); // OceanGold
        public static readonly Color PointMagenta = Color.FromHex("#FF00FF");

        // Context menu button colors - обновлено под OceanStar
        public static readonly Color ButtonColorContext = Color.FromHex("#261218"); // PrimaryPalette.element
        public static readonly Color ButtonColorContextHover = Color.FromHex("#6B1A34"); // OceanSecondary
        public static readonly Color ButtonColorContextPressed = Color.FromHex("#FB6734"); // OceanGold
        ...
        public static readonly Color ExamineButtonColorContextHover = Color.FromHex("#261218"); // PrimaryPalette.element
        public static readonly Color ExamineButtonColorContextPressed = Color.FromHex("#FB6734"); // OceanGold
        public static readonly Color ExamineButtonColorContextDisabled = Color.FromHex("#5A5A5A");

        // Fancy Tree elements - обновлено под OceanStar
        public static readonly Color FancyTreeEvenRowColor = Color.FromHex("#18090d"); // PrimaryPalette.background
        public static readonly Color FancyTreeOddRowColor = FancyTreeEvenRowColor * new Color(0.8f, 0.8f, 0.8f);
        public static readonly Color FancyTreeSelectedRowColor = Color.FromHex("#261218"); // PrimaryPalette.element
        ...
        public static readonly Color ChatBackgroundColor = Color.FromHex("#18090d"); // PrimaryPalette.background
        ...
        public StyleOS(IResourceCache resCache) : base(resCache)
        {
            var notoSans8 = resCache.StackOS(size: 8);
            var notoSans10 = resCache.StackOS(size: 10);
            var notoSansItalic10 = resCache.StackOS(variation: "Italic", size: 10);
            var notoSans12 = resCache.StackOS(size: 12);
            var notoSansItalic12 = resCache.StackOS(variation: "Italic", size: 12);
            var notoSansBold12 = resCache.StackOS(variation: "Bold", size: 12);
            var notoSansBoldItalic12 = resCache.StackOS(variation: "BoldItalic", size: 12);
            var notoSansBoldItalic14 = resCache.StackOS(variation: "BoldItalic", size: 14);
            var notoSansBoldItalic16 = resCache.StackOS(variation: "BoldItalic", size: 16);
            var notoSansDisplayBold14 = resCache.StackOS(variation: "Bold", display: true, size: 14);
            var notoSansDisplayBold16 = resCache.StackOS(variation: "Bold", display: true, size: 16);
            var notoSans15 = resCache.StackOS(variation: "Regular", size: 15);
            var notoSans16 = resCache.StackOS(variation: "Regular", size: 16);
            var notoSansBold16 = resCache.StackOS(variation: "Bold", size: 16);
            var notoSansBold18 = resCache.StackOS(variation: "Bold", size: 18);
            var notoSansBold20 = resCache.StackOS(variation: "Bold", size: 20);
            var notoSansMono = resCache.GetFont("/EngineFonts/NotoSans/NotoSansMono-Regular.ttf", size: 12);

            var windowHeaderTex = resCache.GetTexture("/Textures/Interface/OceanStar/window_header.png");
            ...
            var windowHeaderAlertTex = resCache.GetTexture("/Textures/Interface/OceanStar/window_header_alert.png");
            ...
            var windowBackgroundTex = resCache.GetTexture("/Textures/Interface/OceanStar/window_background.png");
            ...
            var borderedWindowBackgroundTex = resCache.GetTexture("/Textures/Interface/OceanStar/window_background_bordered.png");
            ...
            var buttonRectTex = resCache.GetTexture("/Textures/Interface/OceanStar/light_panel_background_bordered.png");
            ...
            var buttonRectActionMenuItemTex = resCache.GetTexture("/Textures/Interface/OceanStar/black_panel_light_thin_border.png");
            var buttonRectActionMenuRevokedItemTex = resCache.GetTexture("/Textures/Interface/OceanStar/black_panel_red_thin_border.png");
            ...
            var buttonTex = resCache.GetTexture("/Textures/Interface/OceanStar/button.svg.96dpi.png");
            ...
            var chatChannelButtonTex = resCache.GetTexture("/Textures/Interface/OceanStar/rounded_button.svg.96dpi.png");
            ...
            var chatFilterButtonTex = resCache.GetTexture("/Textures/Interface/OceanStar/rounded_button_bordered.svg.96dpi.png");
            ...
            var outputPanelScrollDownButtonTex = resCache.GetTexture("/Textures/Interface/OceanStar/rounded_button_half_bordered.svg.96dpi.png");
            ...
            var smallButtonTex = resCache.GetTexture("/Textures/Interface/OceanStar/button_small.svg.96dpi.png");
            var smallButtonBase = new StyleBoxTexture
            {
                Texture = smallButtonTex,
            };

            var textureInvertedTriangle = resCache.GetTexture("/Textures/Interface/OceanStar/inverted_triangle.svg.png");

            var lineEditTex = resCache.GetTexture("/Textures/Interface/OceanStar/lineedit.png");
            ...
            var actionSearchBoxTex = resCache.GetTexture("/Textures/Interface/OceanStar/black_panel_dark_thin_border.png");
            ...
            var tabContainerPanelTex = resCache.GetTexture("/Textures/Interface/OceanStar/tabcontainer_panel.png");
            ...
            // CheckBox
            var checkBoxTextureChecked = resCache.GetTexture("/Textures/Interface/OceanStar/checkbox_checked.svg.96dpi.png");
            var checkBoxTextureUnchecked = resCache.GetTexture("/Textures/Interface/OceanStar/checkbox_unchecked.svg.96dpi.png");

            // Tooltip box
            var tooltipTexture = resCache.GetTexture("/Textures/Interface/OceanStar/tooltip.png");
            ...
            // Whisper box
            var whisperTexture = resCache.GetTexture("/Textures/Interface/OceanStar/whisper.png");
            ...
            // Placeholder
            var placeholderTexture = resCache.GetTexture("/Textures/Interface/OceanStar/placeholder.png");
            ...
            // NanoHeading
            var nanoHeadingTex = resCache.GetTexture("/Textures/Interface/OceanStar/nanoheading.svg.96dpi.png");
            ...
            // Stripe background
            var stripeBackTex = resCache.GetTexture("/Textures/Interface/OceanStar/stripeback.svg.96dpi.png");
            ...
            // Slider
            var sliderOutlineTex = resCache.GetTexture("/Textures/Interface/OceanStar/slider_outline.svg.96dpi.png");
            var sliderFillTex = resCache.GetTexture("/Textures/Interface/OceanStar/slider_fill.svg.96dpi.png");
            var sliderGrabTex = resCache.GetTexture("/Textures/Interface/OceanStar/slider_grabber.svg.96dpi.png");
            ...
            var sliderFillRed = new StyleBoxTexture(sliderFillBox) { Modulate = OceanRed };
            ...
            Stylesheet = new Stylesheet(BaseRules.Concat(new[]
            {
                ...
                new StyleRule(
                    ...
                    new[]
                    {
                        new StyleProperty(Label.StylePropertyFontColor, OceanGold),
...
// ListContainer
                ...
                new StyleRule(new SelectorElement(typeof(RichTextLabel), new[] {StyleClassLabelKeyText}, null, null), new[]
                {
                    ...
                    new StyleProperty( Control.StylePropertyModulateSelf, OceanGold)
                }),
                ...
                Element<PanelContainer>().Class(OptionButton.StyleClassOptionsBackground)
                    .Prop(PanelContainer.StylePropertyPanel, new StyleBoxFlat(PanelDark)),

                new StyleRule(new SelectorElement(typeof(PanelContainer), new []{ ClassHighDivider}, null, null), new []
                {
                    new StyleProperty(PanelContainer.StylePropertyPanel, new StyleBoxFlat { BackgroundColor = OceanGold, ContentMarginBottomOverride = 2, ContentMarginLeftOverride = 2}),
                }),
                ...
                Element<TextureRect>().Class("NTLogoDark")
                    .Prop(TextureRect.StylePropertyTexture, resCache.GetTexture("/Textures/Interface/OceanStar/ntlogo.svg.png"))
                ...
                Element<TextureButton>().Class("CrossButtonRed")
                    .Prop(TextureButton.StylePropertyTexture, resCache.GetTexture("/Textures/Interface/OceanStar/cross.svg.png"))
                    .Prop(Control.StylePropertyModulateSelf, OceanRed),
                ...
                Element<Button>().Class("ButtonColorRed").Pseudo(ContainerButton.StylePseudoClassHover)
                    .Prop(Control.StylePropertyModulateSelf, OceanGold),
                // ---
                ...
                Element<Label>().Class(SiliconLawContainer.StyleClassSiliconLawPositionLabel)
                    .Prop(Label.StylePropertyFontColor, OceanGold),
