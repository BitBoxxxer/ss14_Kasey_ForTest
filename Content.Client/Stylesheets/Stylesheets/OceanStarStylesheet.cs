...
[Virtual]
public partial class OceanStarStylesheet : CommonStylesheet
{
    public override string StylesheetName => "OceanStar";

    public override NotoFontFamilyStack BaseFont { get; } // TODO: NotoFontFamilyStack is temporary


    public static readonly ResPath TextureRoot = new("/Textures/Interface/OceanStar");
    ...
    public OceanStarStylesheet(object config, StylesheetManager man) : base(config)
    {
        ...
        var rules = new[]
        {
            ...
            GetAllSheetletRules<OceanStarStylesheet, CommonSheetletAttribute>(man),
        };
